...
fetched_from = 'soservi.jobs.recrut.ai'
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://soservi.jobs.recrut.ai/company/public-jobs/*/*/*/*/*/?_=1681224004820' ,
        )
      }
    ),
)
...
def crawl(web):
    ...
    sl.WR = ["https://soservi.jobs.recrut.ai/job/{0}".format(x.get("url","")) for x in sl.M]
