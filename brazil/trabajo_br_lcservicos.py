...
fetched_from = 'lcsservicos.abler.com.br'
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://lcsservicos.abler.com.br/api_v/v1/vagas.json?&page=1' ,
        )
      }
    ),
)
...
def crawl(web):
    ...
    sl.extract(xtr_url)
    sl.WR = ["https://lcsservicos.abler.com.br/vagas/{0}".format(x.get('url', '')) for x in sl.M]
