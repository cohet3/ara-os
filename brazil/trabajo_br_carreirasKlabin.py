...
fetched_from = 'carreiras.klabin.com.br'
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://carreiras.klabin.com.br/go/Trabalhe-com-a-gente/8804200/' ,
        )
      }
    ),
)
...
def crawl(web):
    ...
    sl.extract(xtr_url)
    sl.WR = ["https://carreiras.klabin.com.br{0}".format(x.get('url', '')) for x in sl.M]
