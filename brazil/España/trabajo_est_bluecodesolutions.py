...
fetched_from = 'bluecodesolutions.zohorecruit.eu'
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://bluecodesolutions.zohorecruit.eu',
        )
    }
     ),
)
...
def crawl(web):
    ...
    sl.extract(xtr_url)
    sl.WR = ["https://bluecodesolutions.zohorecruit.eu/jobs/Careers/{0}".format(x.get("url", "")) for x in sl.M]
