...
fetched_from = 'estapar.pandape.infojobs.com.br'

xtr = '''title
<title>Vaga de
-
city
<meta name="twitter:title" content="Vaga de .*? -
" />
description
<p class="c-drk font-lg text-break-word">
<div class="py-20">'''
...
# city
# <p class="mb-0 ml-05 fw-600 text-nowrap lh-140">
# </p>
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://estapar.pandape.infojobs.com.br/' ,
        )
      }
    ),
)
