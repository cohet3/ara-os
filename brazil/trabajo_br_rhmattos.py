...
fetched_from = 'rhmattos.selecty.com.br'
...
def crawl(web):
    ...
    for offer in sl.M:
        ...
        ad['company'] = offer.get("company","RhMattos")
        ad['contract'] = offer.get("contract", "CLT (Efetivo)")
