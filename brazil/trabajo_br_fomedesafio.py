...
fetched_from = 'fomededesafio.com.br'
...
description
<span itemprop="description" class="jobdescription"><p>
</p>'''
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://fomededesafio.com.br/search/?createNewAlert=false&q=&locationsearch=' ,
        )
      }
    ),
)
