...
fetched_from = 'trinnusrh.zohorecruit.com'
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://trinnusrh.zohorecruit.com/jobs/Careers' ,
        )
      }
    ),
)
...
def crawl(web):
    ...
    sl.extract(xtr_url)
    sl.WR = ["https://trinnusrh.zohorecruit.com/jobs/Careers/{0}".format(x.get("url", "")) for x in sl.M]
    ##############################
    #Para pruebas
    # sl.printWR()
    #sl.printM()
