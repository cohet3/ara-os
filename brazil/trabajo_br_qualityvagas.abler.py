...
fetched_from = 'qualityvagas.abler.com'
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://qualityvagas.abler.com.br/api_v/v1/vagas.json?&page=1' ,
        )
      }
    ),
)
...
def crawl(web):
    ...
    sl.extract(xtr_url)
    sl.WR = ["https://qualityvagas.abler.com.br/vagas/{0}".format(x.get('url', '')) for x in sl.M]
    ...
    for offer in sl.M:
        ...
        ad['company'] = offer.get("company", "Hippo Supermercados")
