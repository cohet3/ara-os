...
fetched_from = 'vagas.cvale.com.br'
...
"
description
<H2 style="font-size:1.0em;margin:0.0px">Descrição</H2>
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://vagas.cvale.com.br/search/?createNewAlert=false&q=&locationsearch=&optionsFacetsDD_city=&optionsFacetsDD_state=' ,
        )
      }
    ),
)
