...
description
<ul class="list-inline is-spaced mb-2">
<div class="section section-payoff bg-payoff-1 text-white">'''
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://www.jobonbeauty.com/it/offerte-di-lavoro/',
        )
    }
     ),
)
