...
<div class="col mt-5 job-description">
city
<p class="mb-0">Luogo:
</p>'''

xtr_url='''url
<h3 class="job-title"><a href="
" class='''
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://www.asapitalia.com/index.php/it/component/chronoconnectivity6/?cont=manager&conn=job-list&article_id=196&event=index&startat=0',
        )
    }
     ),
)
