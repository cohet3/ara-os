...
url
<a href="https://frigel.intervieweb.it/jobs
"'''
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://frigel.intervieweb.it/en/career',
        )
    }
     ),
)
...
def crawl(web): 
    ...
    sl.extract(xtr_url)
    sl.WR = ["https://frigel.intervieweb.it/jobs{0}".format(x.get("url", "")) for x in sl.M]
    ##############################
    # Para pruebas
    # sl.printWR()
    # sl.printM()
