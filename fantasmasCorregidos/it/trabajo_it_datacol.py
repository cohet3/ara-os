...
fetched_from = 'datacol.intervieweb.it'
...
xtr_url='''url
<a href="https://datacol.intervieweb.it/jo
"'''
# stp = '/jobs/'
page_ads =11 
page_stp = 1
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://datacol.intervieweb.it/es/career',
        )
    }
     ),
)
...
def crawl(web): 
    ...
    sl.extract(xtr_url)
    sl.WR = ["https://datacol.intervieweb.it/jo{0}".format(x.get('url', '')) for x in sl.M]
