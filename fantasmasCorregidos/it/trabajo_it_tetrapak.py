...
fetched_from = 'jobs.tetrapak.com'

xtr = '''title
<h1 id="job-title" itemprop="title">
</h1>
city
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://jobs.tetrapak.com/search/?createNewAlert=false&q=&locationsearch=Italy&optionsFacetsDD_customfield1=',
        )
    }
     ),
)
