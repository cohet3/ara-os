...
fetched_from = 'careers.agcocorp.com'
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://careers.agcocorp.com/search/?createNewAlert=false&q=&locationsearch=Italy&optionsFacetsDD_lang=&optionsFacetsDD_country=',
        )
    }
     ),
)
