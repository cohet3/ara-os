...
fetched_from = 'jobs.ericsson.com'
...
pagination_generator = lambda url: (url.format(page=page) for page in xrange(0, 25, 25))
# with Controller.from_port(port = 9051) as controller:
# pass
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://jobs.ericsson.com/search/?q=&locationsearch=italy&startrow={page}',
        )
    }
     ),
)
