...
fetched_from = 'careers.dovercorporation.com'
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://careers.dovercorporation.com/search/?createNewAlert=false&q=&locationsearch=Italy&optionsFacetsDD_department=&optionsFacetsDD_facility=',
        )
    }
     ),
)
