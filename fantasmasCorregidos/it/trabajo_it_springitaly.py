...
xtr_url= '''url
href="https://www.springitaly.com/it-it/job/
"'''
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://www.springitaly.com/it-it/trova-lavoro/job-results/?k=&l=italy&xy=41.8719%2c12.5674&display=15&pageNum={page}',
        )
    }
     ),
)
...
def crawl(web): 
    ...
    sl.extract(xtr_url)
    sl.WR = ["https://www.springitaly.com/it-it/job/{0}".format(x.get("url", "")) for x in sl.M]
