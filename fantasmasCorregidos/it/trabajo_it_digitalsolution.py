...
fetched_from = 'digitalsolution.it'
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://www.digitalsolution.it/en/open-positions',
        )
    }
     ),
)
...
def crawl(web): 
    ...
    sl.extract(xtr_url)
    sl.WR = ["https://www.digitalsolution.it/en/{0}".format(x.get("url", "")) for x in sl.M]
