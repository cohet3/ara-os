...
fetched_from = 'avangarde.it'

xtr = '''title
<h3 class="col-12 dkblue font-weight-bold text-uppercase">
</h3>
contract
...
description
 <span class="badge badge-dark"><i class="fas fa-calendar-alt"></i>
<section class="std bottomform">'''
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'http://avangarde.it/site/offerte.aspx',
        )
    }
     ),
)
