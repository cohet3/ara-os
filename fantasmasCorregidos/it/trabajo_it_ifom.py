...
description
<span class="docuCenter-comunicati-entrylist">
<div class="thumbnail">'''
...
stp = '/it/opportunita-lavoro/posizioni-aperte/.+?'
stp2 = 'docuID='
page_ads =11 
page_stp = 1
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://www.ifom.eu/it/opportunita-lavoro/aperte/',
        )
    }
     ),
)
