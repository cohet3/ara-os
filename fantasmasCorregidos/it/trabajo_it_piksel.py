...
xtr_url='''url
<li class="position transition"><a href="
"
location
<li class="location">
</li>'''
...
def crawl(web): 
    ...
    # sl.step(stp)
    sl.extract(xtr_url)
    sl.WR= ["https://piksel.breezy.hr{0}".format(x.get("url", "")) if "IT" in x.get("location", "") else "" for x in sl.M]
