...
fetched_from = 'devupconsulting.com'

xtr = '''title
<div class="job-post clearfix"  role="main">.*?<div  class="jobs-row-input">
</div>
description
<p>
<div class="job-side">
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://www.devupconsulting.com/jobs/',
        )
    }
     ),
)
