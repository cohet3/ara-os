...
extra
<div class="elementor-element elementor-element-be1a675 elementor-widget elementor-widget-text-editor" data-id="be1a675" data-element_type="widget" data-widget_type="text-editor.default">
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://www.studiosila.it/category/offerte-di-lavoro/',
        )
    }
     ),
)
