...
fetched_from = 'huntsman.wd1.myworkdayjobs.com'
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://huntsman.wd1.myworkdayjobs.com/Huntsman/2/replaceFacet/318c8bb6f553100021d223d9780d30be' ,
        )
      }
    ),
)
...
def crawl(web):
    ...
    headers = {
        ...
        "Origin":"https://huntsman.wd1.myworkdayjobs.com",
        "Referer":"https://huntsman.wd1.myworkdayjobs.com/External/2/refreshFacet/318c8bb6f553100021d223d9780d30be",
    ...
    sl.extract(xtr_url)
    urls = ["https://huntsman.wd1.myworkdayjobs.com{0}".format(x.get("url", "")) for x in sl.M]
    sl.WR = urls
    #Para pruebas
    #sl.printWR()
    #sl.printM()
