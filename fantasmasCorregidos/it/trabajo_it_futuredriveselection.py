...
fetched_from = 'lavora-con-noi.futuredriveselection.it'
...
url
<a href="https://inrecruiting.intervieweb.it
"'''

stp = '/offerte-di-lavoro/ -annunci'
page_ads =11 
page_stp = 1
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://inrecruiting.intervieweb.it/futuredrive/it/career',
        )
    }
     ),
)
...
def crawl(web): 
    ...
    sl.extract(xtr_url)
    sl.WR = ["https://inrecruiting.intervieweb.it{0}".format(x.get("url", "")) for x in sl.M]
    ##############################
