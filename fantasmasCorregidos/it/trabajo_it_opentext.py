...
fetched_from = 'careers.opentext.com'
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://careers.opentext.com/search/?createNewAlert=false&q=&locationsearch=italy&optionsFacetsDD_department=&optionsFacetsDD_location=',
        )
    }
     ),
)
