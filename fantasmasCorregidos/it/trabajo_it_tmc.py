...
fetched_from = 'tmc-employeneurship.com'
...
description
<div class="article__cta-block image-block">
<div class="cta l-padding">'''
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://tmc-employeneurship.com/careers?expertise=&country=it#filter-results',
        )
    }
     ),
)
