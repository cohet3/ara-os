...
fetched_from = 'careers.steris.com'
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://careers.steris.com/search/?createNewAlert=false&q=&locationsearch=Italy&optionsFacetsDD_department=&optionsFacetsDD_country=',
        )
    }
     ),
)
