...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://www.jobintur.it/#annunci-attivi-section',
        )
    }
     ),
)
...
def crawl(web): 
    ...
    for offer in sl.M:
        ...
        ad['description'] = re.sub("\\\\n|\\\\r|\\\\t","", offer.get("description", "").decode("unicode-escape").encode("latin"))
        ad['url'] = "https://www.jobintur.it" + offer.get("@url", "")
