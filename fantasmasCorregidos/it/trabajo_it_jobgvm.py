...
fetched_from = 'jobgvm.intervieweb.it'
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://jobgvm.intervieweb.it/it/career#vacancies',
        )
    }
     ),
)
