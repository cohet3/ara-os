...
"'''
#el salario con la etiqueta me sale asi \x22\x3A\x22\x2418,000.00\x22,\ se podra corregir con decode
# salary
# x22Salario_Neto_Mensual
# x22Entrevista_Remota
...
def crawl(web):
    ...
    for offer in sl.M:
        ...
        ad['salary'] = offer.get("salary", '0').decode('utf8', 'strict')
