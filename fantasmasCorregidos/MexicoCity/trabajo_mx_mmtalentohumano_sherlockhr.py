...
fetched_from = 'mmtalentohumano.sherlockhr.computrabajo.com'
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://mmtalentohumano.sherlockhr.computrabajo.com/ofertas/' ,
        )
      }
    ),
)
...
def crawl(web):
    ...
    headers = { 
        ...
        'pragma':'no-cache',
        'referer':'https://mmtalentohumano.sherlockhr.computrabajo.com/ofertas/',
    ...
    sl.extract(xtr_url)
    sl.WR = ["https://mmtalentohumano.sherlockhr.computrabajo.com{0}".format(x.get('url', '')) for x in sl.M]
