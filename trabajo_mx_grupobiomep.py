...
fetched_from = 'grupobiomep.sherlockhr.computrabajo.com'
...
pages = (
    ('Trabajo', {
        'trabajo_subcat': (
            'https://grupobiomep.sherlockhr.computrabajo.com/ofertas/' ,
        )
      }
    ),
)
...
def crawl(web):
    ...
    sl.extract(xtr_url)
    sl.WR = ["https://grupobiomep.sherlockhr.computrabajo.com{0}".format(x.get('url', '')) for x in sl.M]
